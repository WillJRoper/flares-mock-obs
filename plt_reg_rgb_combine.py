...
for snap in snaps:
    ...
    for reg in regions:
        ...
        left = np.random.choice(np.arange(0, (rgb_img.shape[0] * res * 8) - img.shape[0]))
        top = np.random.choice(np.arange(0, (rgb_img.shape[1] * res * 8) - img.shape[1]))
        print(rgb_img.shape, res, res * 8, left, top)
