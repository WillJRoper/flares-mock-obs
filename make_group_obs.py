...
def lum_to_m(lum, z, cosmo): return flux_to_m(lum_to_flux(lum, cosmo, z))
...
depths = [XDF_depth_flux * 0.1, XDF_depth_flux, 10 * XDF_depth_flux]
    ...
    for num, depth in enumerate(depths):
        ...
        for key in image_keys:
            ...
            if orientation == "sim" or orientation == "face-on":
                ...
                img = util.make_spline_img_3d(this_pos, npix, 0, 1, 2, tree,
                                              this_flux, this_smls,
                                              spline_func=util.cubic_spline,
                                              spline_cut_off=1)
                mimg = util.make_spline_img_3d(this_pos, npix, 0, 1, 2, tree,
